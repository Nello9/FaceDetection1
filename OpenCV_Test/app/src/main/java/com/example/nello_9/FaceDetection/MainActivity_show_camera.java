...
public class MainActivity_show_camera extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener2 {
    public String mCameraId="2";

    private static final String TAG = "vedo";
        int a,b,c,d;
Boolean k=false;
    Boolean l=false, contr=false, nulla=false;
    CascadeClassifier cascadeClassifier;
  CascadeClassifier cascadeClassifierDESTRO;
    CascadeClassifier cascadeClassifierSINISTRO;
    private int absoluteFaceSize, sizeSin,contatore=-10;
   ...
   Mat grey;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i(TAG,"prima camera: "+mCameraId);
    ...
    public Mat onCameraFrame(CameraBridgeViewBase.CvCameraViewFrame inputFrame) {
        ...
        if (contatore>0 && !k) {
            ...
            absoluteFaceSize = (int) (mRgba.rows()* 0.6);
            sizeSin=(int) (absoluteFaceSize*0.3);
    ...
    public ArrayList<String> SaveImage () {
        ...
        if(!contr){
            ...
            Log.i(TAG,"STO PROVANDO il potrait");
        ...
        File pp= Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DCIM+"/FotoViso/VisoSenzaSoggetto");
        if (!pp.exists()){
            pp.mkdir();
        }
